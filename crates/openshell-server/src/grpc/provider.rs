...
mod tests {
    ...
    use openshell_core::proto::{
        ...
        ListProviderProfilesRequest, NetworkBinary, NetworkEndpoint, NetworkPolicyRule,
        ...
        ProviderProfileCredential, ProviderProfileImportItem, Sandbox, SandboxPolicy, SandboxSpec,
